                ...
                <div className="questionnaire-body">
                    ...
                    <div className="questionnaire-footer">
                        <button 
                            ...
                            onClick={async () => {
                                // ADDED THE NEW STATES HERE so Gemini knows about them!
                                const rawAnswers = { usage, budget, needsWifi, preferences, gameTypes, resolution, quality, contentTypes, aiTasks, generalTask, storage };
